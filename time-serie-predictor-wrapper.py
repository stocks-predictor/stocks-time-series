...
class OnlyPredictor():
    ...
    def load_model(self, name = 'my_model'):
...
if __name__ == '__main__':
    ...
    parser.add_argument('-t', '--type', type=str, default='twoFeatures', help='what predictor do you usage. (options: twoFeatures, oneFeature, onlyPredictor)')
    ####################################GLOBAL VARIABLES#############################################################
    #test_set_size= 50
    ...
    predictorsOptions = {'twoFeatures': TimeSeriePredictorTwoFeatures, 'onlyPredictor': OnlyPredictor}

    if (predictorType == 'onlyPredictor'):
        predictor = OnlyPredictor(look_back = look_back)
